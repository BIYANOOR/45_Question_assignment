...
let message = `${fam_person}once said ,"${fam_quote}"`;
console.log(message);
...
let strippedName = name_with_white_space.trim();
...
let myOwnTransport = ["Car", "Bus", "Bike"];
//with for each method /syntax 
myOwnTransport.forEach(myOwnTransport => {
...
let guestList = ["Fatima", "Azra", "Sobi"];
...
let unAbleToAttendDinner = guestList.splice(1, 1)[0];
...
let placesToVisit = ["Paris", "Spain", "Itlay", "France", "Japan"];
...
let bakraEidDinnerMenu = ["Tikka", "Karhai", "Qorma", "Biryani", "Seekh Kabab", "Chapli Kabab"];
console.log(bakraEidDinnerMenu);
console.log(bakraEidDinnerMenu.forEach(Dish => {
    console.log(Dish);
}));
...
console.log("there is no value exist on number 10 that's why it shows an error undefined");
...
let myFavoriteFruits = ["Apple", "Banana", "Mango"];
...
// Array of usernames
let usernames = ["Ali", "Rukhsana", "Bilal", "Admin", "Fareeda", "Fatima"];
...
let username = ["Ali", "Rukhsana", "Bilal", "Admin", "Fareeda", "Fatima"];
...
// Array of usernames
let usernames1 = ["Ali", "Rukhsana", "Bilal", "Admin", "Fareeda", "Fatima"];
// Check if the array is empty
...
let current_users = ["Ali", "Rukhsana", "Bilal", "Admin", "Fareeda", "Fatima"];
//• Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ["Eman", "Farah", "Ali", "Fareeda", "Saad"];
...
let pizzas = ["Pepperoni", "Chicken cheese ", "BBQ Chicken"];
...
let magicians = ["Hamoon jadoger", "Nastoor jin", "Bilpatori", "Imran megician"];
